                ...
                <div className="detail-news__content">
                  ...
                  <div className="detail-news__main">
                    ...
                    <p className="detail-news__text">
                      ...
                      <b>khách hàng X-Star </b> được tặng <b>04 vé 2D miễn phí </b> trong tài khoản
                      và <b>miễn phí đổi vị bắp</b> từ ngày 01/01/2020.
                    </p>
                    ...
                    <p className="detail-news__text">
                      Thành viên mua bất kỳ sản phẩm vé xem phim, nước uống, thức ăn, combo … tại
                      các cụm rạp Galaxy hoặc thanh toán trực tuyến sẽ được tích lũy điểm thưởng
                      tương ứng vào tài khoản
                    </p>
                    <p className="detail-news__text">
                    ...
                    <p className="detail-news__text">
                      Với các trường hợp không hợp lệ, Galaxy Cinema có quyền xóa tài khoản thành
                      viên mà không cần thông báo trước.
                    </p>
                    <p className="detail-news__text">
                      Tài khoản thành viên không có đủ thông tin định danh gồm <b>Email</b> và{' '}
                      <b>số điện thoại hợp lệ</b> , Galaxy Cinema có quyền xóa tài khoản thành viên
