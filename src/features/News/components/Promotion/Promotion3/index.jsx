        ...
        <div className="col-12 col-lg-8">
          ...
          <div className="detail-news__content">
            ...
            <div className="detail-news__main">
              ...
              <p className="detail-news__text">
                Từ 31.12.2019, các Star <b>sẽ được thăng hạng thành </b> Star, G-star, X-star tương
                ứng với <b> tổng chi tiêu trong năm 2019</b> và <b> nhận các ưu đãi đặc biệt mới</b>
                :
              </p>
              ...
              <p className="detail-news__text">
                ...
                <b>mỗi khách hàng G-Star </b> được tặng <b> 02 vé 2D miễn phí </b> trong tài khoản
                và <b>miễn phí đổi vị bắp</b> từ ngày 01/01/2020; <b>khách hàng X-Star </b> được
                tặng <b>04 vé 2D miễn phí </b> trong tài khoản và <b>miễn phí đổi vị bắp</b> từ ngày
                01/01/2020.
              </p>
              ...
              <p className="detail-news__text">
                Thành viên mua bất kỳ sản phẩm vé xem phim, nước uống, thức ăn, combo … tại các cụm
                rạp Galaxy hoặc thanh toán trực tuyến sẽ được tích lũy điểm thưởng tương ứng vào tài
                khoản
              </p>
              <p className="detail-news__text">
                Lưu ý: Đối với những giao dịch trực tuyến, thành viên phải đăng nhập vào tài khoản
                mới được quyền tích điểm hợp lệ.
              </p>
              <p className="detail-news__text">
                <b>Đổi quà hấp dẫn:</b>
              </p>
              ...
              <p className="detail-news__text">
                Điểm tích lũy còn tồn đọng sẽ bị trừ khỏi tài khoản thành viên sau ngày 31/12/2019
              </p>
              <p className="detail-news__text">
                <b>Thông tin định danh thành viên</b> gồm có <b>email</b> và <b>số điện thoại</b>{' '}
                bắt buộc phải hợp lệ.
              </p>
              <p className="detail-news__text">
                <b>Số điện thoại không hợp lệ</b> là số điện thoại không liên lạc được hoặc số điện
                thoại không thuộc sở hữu của chủ tài khoản thành viên ở thời điểm Galaxy Cinema rà
                soát dữ liệu thành viên.
              </p>
              <p className="detail-news__text">
                Với các trường hợp không hợp lệ, Galaxy Cinema có quyền xóa tài khoản thành viên mà
              ...
              <p className="detail-news__text">
                Điểm tích lũy có giá trị áp dụng tại tất cả các rạp Galaxy Cinema trên toàn quốc.
              </p>
              <p className="detail-news__text">
                Bạn có thể dễ dàng kiểm tra điểm tích lũy của mình trên Website Galaxy Cinema hoặc
