                ...
                <div className="detail-news__content">
                  ...
                  <div className="detail-news__main">
                    <p className="detail-news__text">
                      Từ lâu, chương trình <b>Ngày Tri Ân</b> Nhằm tạo điều kiện thuận lợi hơn cho
                      các khách hàng thả ga xem phim đã trở nên quen thuộc với các khách hàng thân
                      yêu của Galaxy Cinema.
                    </p>
                    <p className="detail-news__text">
                      Vậy là, ngày 01/02/2021, các Stars sẽ được xem phim thả ga với giá vé đồng
                      nhất <b> 45.000 đ</b> cho tất cả các phim 2D. Ngoài ra, trong{' '}
                      <b>Ngày Tri Ân</b> này, khách hàng còn được nhận một ưu đãi đặc biệt - thoải
                      mái thưởng thức bắp nước khi được 01 lần Refill miễn phí với tất cả các phần
                      bắp và nước ngọt dạng ly (Pepsi, 7Up, Mirinda Cam/Mirinda Sarsi), Lipton Trà
                      Chanh 22oz và Combo đang bán tại rạp.
                    </p>
                    ...
                    <p className="detail-news__text">
                      ** Vui lòng xuất trình hóa đơn và hộp bắp/ ly nước khi yêu cầu refill, chỉ áp
                      dụng refill bắp nước trước 22:00.
                    </p>
                    <p className="detail-news__text">
                      Đừng bỏ lỡ Ngày Tri Ân tại <b>G2 Cinema</b> - <b>Ngày thứ Hai ĐẦU TIÊN</b> của
                      mỗi tháng. Với <b>Ngày Tri Ân</b> , các Stars chắc chắn sẽ có thêm nhiều trải
                      nghiệm tuyệt vời và một buổi xem phim thú vị tại <b>G2 Cinema</b>. Đặt vé ngay
                      vào ngày 01/02/2021 này nhé!
                    </p>
                  </div>
                </div>
