          ...
          <div className="detail-news__content">
            ...
            <div className="detail-news__main">
              <p className="detail-news__text">
                Đã ra rạp xem phim thì mười người hết… mười một đều “phải lòng” món bắp rang ngọt
                ngào thơm phức. Mùi bắp rang bơ tỏa khắp từ sảnh chờ cho đến phòng chiếu, giúp việc
                thưởng thức phim trở nên hấp dẫn gấp trăm lần.
              </p>
              ...
              <p className="detail-news__text">
                ...
                caramel; giờ đây, Galaxy Cinema cho ra mắt vị bắp mới – vô cùng quyến rũ mang tên
                bắp Milo ( thêm 9.000 đ).
              </p>

              <p className="detail-news__text">
                Đến Galaxy Cinema để được đắm chìm trong món bắp mới ngọt ngào thơm hương Milo nào
                các Stars!
              </p>
              <p className="detail-news__text">
                Đã ra rạp xem phim thì mười người hết… mười một đều “phải lòng” món bắp rang ngọt
                ngào thơm phức. Mùi bắp rang bơ tỏa khắp từ sảnh chờ cho đến phòng chiếu, giúp việc
                thưởng thức phim trở nên hấp dẫn gấp trăm lần. Giữ chân biết bao “mọt phim” suốt
                nhiều năm qua nhờ bắp ngọt, bắp phô mai và bắp caramel; giờ đây, Galaxy Cinema cho
                ra mắt vị bắp mới – vô cùng quyến rũ mang tên bắp Milo ( thêm 9.000 đ). Đến Galaxy
                Cinema để được đắm chìm trong món bắp mới ngọt ngào thơm hương Milo nào các Stars!
              </p>
            </div>
          </div>
