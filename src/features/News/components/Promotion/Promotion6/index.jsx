        ...
        <div className="col-12 col-lg-8">
          ...
          <div className="detail-news__content">
            ...
            <div className="detail-news__main">
              ...
              <p className="detail-news__text">
                Không khí xuân tràn ngập khắp rạp chiếu, còn gì tuyệt hơn khi thưởng thức những
                thước phim chất lượng, lại còn được miễn phí vé và thỏa thích nhâm nhi trà cực đã.
              </p>
              <p className="detail-news__text">
                Chần chờ gì nữa, hãy tới ngay Trạm Dừng Điện Ảnh Galaxy Cinema để check-in và chính
                thức tham gia vào tuần lễ tiệc trà tất niên lớn nhất trong năm!
              </p>
              ...
              <p className="detail-news__text">
                - Miễn phí vé cho khách hàng có ngày sinh nhật trong khoảng từ 15/01 – 31/01. (Áp
                dụng khi đi từ nhóm 05 người trở lên.)
              </p>
              <p className="detail-news__text">
                - Miễn phí trà Táo/Red Velvet cho nhóm khách đi từ 05 người trở lên. (Áp dụng cho
              ...
              <p className="detail-news__text">
                - Mỗi khách chỉ được miễn phí 01 vé xem phim trong suốt thời gian diễn ra chương
                trình.
              </p>
              <p className="detail-news__text">
