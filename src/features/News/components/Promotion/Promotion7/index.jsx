                ...
                <div className="detail-news__content">
                  ...
                  <div className="detail-news__main">
                    <p className="detail-news__text">
                      Tri ân tình cảm của các Stars, <b>G2 Cinema</b> dành tặng hàng loạt ưu đãi
                      chưa – từng – có mừng 2021.
                    </p>
                    <p className="detail-news__block-image">
                      <img src={pro7} alt={pro7} width="600px" height="350px"></img>
                    </p>
                    <p className="detail-news__text">
                      Thành viên Star chi tiêu đủ mức G-Star, X-Star trong năm 2020 sẽ được nâng
                      hạng và hưởng quyền lợi mới tương ứng. Nếu mức chi tiêu không đủ vẫn giữ
                      nguyên hạng mức cũ.
                    </p>
                    <p className="detail-news__text">
                      Thành viên G-Star chi tiêu đủ mức X-Star trong năm 2020 sẽ được nâng hạng và
                      hưởng quyền lợi mới X-Star tương ứng. Nếu mức chi tiêu không đủ vẫn giữ nguyên
                      hạng mức cũ G-Star.
                    </p>
                    ...
                    <p className="detail-news__text">
                      Vé miễn phí và Điểm tích lũy (Stars) sẽ được bảo lưu và tiếp tục sử dụng trong
                      năm 2021.
                    </p>
                    <p className="detail-news__text">
                      Cảm ơn các Stars đã đồng hành cùng <b>G2 Cinema</b> trong một năm 2020 với rất
