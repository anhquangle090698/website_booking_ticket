              ...
              <div className="detail-news__content">
                ...
                <div className="detail-news__main">
                  <p className="detail-news__text">
                    Tri ân tình cảm của các Stars, <b>G2 Cinema</b> dành tặng hàng loạt ưu đãi chưa
                    – từng – có mừng 2021.
                  </p>
                  ...
                  <p className="detail-news__text">
                    Thành viên Star chi tiêu đủ mức G-Star, X-Star trong năm 2020 sẽ được nâng hạng
                    và hưởng quyền lợi mới tương ứng. Nếu mức chi tiêu không đủ vẫn giữ nguyên hạng
                    mức cũ.
                  </p>
                  <p className="detail-news__text">
