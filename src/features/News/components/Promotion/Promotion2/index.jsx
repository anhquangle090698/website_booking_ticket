        ...
        <div className="col-12 col-lg-8">
          ...
          <div className="detail-news__content">
            ...
            <div className="detail-news__main">
              ...
              <p className="detail-news__text">
                Cụ thể vào <b>Thứ 4 cuối cùng mỗi tháng</b> , khách hàng thành viên Galaxy Cinema
                khi mua Milo ly 22oz sẽ chỉ với giá <b>9.000 VNĐ</b> . Bạn chỉ cần trình thẻ thành
                viên/ app Galaxy là đã có thể sở hữu một ly Milo ngọt ngào với giá siêu “mềm”.
              </p>
              <p className="detail-news__block-image">
                <img src={pro2} alt={pro2} width="600px" height="350px"></img>
              </p>
              <p className="detail-news__text">
                Như vậy, sau <b>Ngày Tri Ân</b> và <b>Happy Day</b>, <b>Milo Day</b> sẽ là sự kiện
              ...
              <p className="detail-news__text">
                Tham dự buổi công chiếu ra mắt cùng các sao: cơ hội cùng các ngôi sao nổi tiếng tham
                dự buổi ra mắt phim.
              </p>
            </div>
          </div>
