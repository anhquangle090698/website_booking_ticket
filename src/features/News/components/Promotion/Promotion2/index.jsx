              ...
              <div className="detail-news__content">
                ...
                <div className="detail-news__main">
                  ...
                  <p className="detail-news__text">
                    ...
                    Cinema khi mua Milo ly 22oz sẽ chỉ với giá <b>9.000 VNĐ</b> . Bạn chỉ cần trình
                    thẻ thành viên/ app Galaxy là đã có thể sở hữu một ly Milo ngọt ngào với giá
                    siêu “mềm”.
                  </p>
                  ...
                  <p className="detail-news__text">
                    Tham dự buổi công chiếu ra mắt cùng các sao: cơ hội cùng các ngôi sao nổi tiếng
                    tham dự buổi ra mắt phim.
                  </p>
                </div>
              </div>
