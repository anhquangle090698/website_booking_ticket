        ...
        <div className="col-12 col-lg-8">
          ...
          <div className="detail-news__content">
            ...
            <div className="detail-news__main">
              ...
              <p className="detail-news__text">
                Trạm Dừng Chân Điện Ảnh <b>G2 Cinema</b> dành tặng lì xì may mắn cho các Stars, khi
                đến thưởng thức loạt siêu phẩm mùa phim Tết đang được mong chờ nhất.
              </p>
              <p className="detail-news__text">
                Hãy chuẩn bị bước vào chuyến phiêu lưu cùng Tí và nhóm bạn thân trong{' '}
                <i>Trạng Tí Phiêu Lưu Ký</i> . Sau đấy là trải nghiệm một kỳ nghỉ ngắn hạn tại Huế,
                để chiêm ngưỡng sự giàu sang vương giả tại Bạch Trà Viên với{' '}
                <i>Gái Già Lắm Chiêu V</i> . Kế đó, đi tour về miền Tây sông nước, tham gia vào
                những pha hành động rượt đuổi đầy thót tim bằng <i>Lật Mặt 48H</i> . Cuối cùng di
                chuyển về Sài Gòn để cùng cười, cùng khóc với <i>Bố Già</i> tuy lắm chuyện nhưng
                đáng mến.
              </p>
              ...
              <p className="detail-news__text">- Không giới hạn số lần nhận bao lì xì của khách.</p>
              <p className="detail-news__text">
