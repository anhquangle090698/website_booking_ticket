          ...
          <div className="detail-news__content">
            ...
            <div className="detail-news__main">
              <p className="detail-news__text">
                Mở rộng quyền lợi thành viên <b>G2 Cinema</b> với tính năng đổi điểm mới dành cho
                các Stars thân yêu. Tự do quy đổi SAO sang điểm VUI của TAPTAP để có thêm nhiều lựa
              ...
              <p className="detail-news__text">
                <b>G2 Cinema</b> xin trân trọng giới thiệu sự đồng hành của Ứng dụng tích-đổi điểm
                TAPTAP. Dễ dàng tích điểm thành viên và đổi ưu đãi cực “hời” ở nhiều thương hiệu
                khác nhau như: The Pizza Company, Otoké Chicken, Chewy Chewy, The Coffee Club, Jump
                Arena,...Tất cả trên cùng 1 ứng dụng TAPTAP.
              </p>
              <p className="detail-news__text">
                Với TAPTAP, mỗi điểm nhận được là một niềm “VUI”. <br></br>
                Các Stars sẽ có thêm lựa chọn quy đổi điểm SAO sang VUI và sử dụng các ưu đãi độc
                quyền trên TAPTAP với tỉ lệ: 1 VUI = 10 SAO.
              </p>
              ...
              <p className="detail-news__text">
                ⭐ B3: Nhập số VUI bạn muốn nhận, hệ thống sẽ tự động tính ra số SAO bạn cần dùng để
                đổi
              </p>
              <p className="detail-news__block-image">
                <img src={pro42} alt={pro42} width="600px" height="350px"></img>
              </p>
              <p className="detail-news__text">⭐ B4: Xác nhận và mở TAPTAP lên để đón VUI về</p>
              <p className="detail-news__block-image">
