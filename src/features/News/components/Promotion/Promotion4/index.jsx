                ...
                <div className="detail-news__content">
                  ...
                  <div className="detail-news__main">
                    <p className="detail-news__text">
                      ...
                      nhiều lựa chọn ưu đãi hấp dẫn với đa dạng lĩnh vực từ ăn uống, mua sắm, giải
                      trí cho đến du lịch.
                    </p>
                    ...
                    <p className="detail-news__text">
                      ...
                      điểm TAPTAP. Dễ dàng tích điểm thành viên và đổi ưu đãi cực “hời” ở nhiều
                      thương hiệu khác nhau như: The Pizza Company, Otoké Chicken, Chewy Chewy, The
                      Coffee Club, Jump Arena,...Tất cả trên cùng 1 ứng dụng TAPTAP.
                    </p>
                    <p className="detail-news__text">
