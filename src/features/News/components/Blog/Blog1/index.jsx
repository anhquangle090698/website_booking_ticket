              ...
              <div className="detail-news__content">
                ...
                <div className="detail-news__main">
                  ...
                  <p className="detail-news__text">
                    ...
                    Hoài Linh xuất hiện, không cần quan tâm kịch bản hay dàn diễn viên phụ, khán giả
                    vẫn đổ xô ra rạp chiếu phim. <i>Hello Cô Ba</i> (doanh thu hơn 25 tỷ),{' '}
                    <i>Nhà Có 5 Nàng Tiên</i> (doanh thu trên 60 tỷ), <i>Tía Tui Là Cao Thủ</i>{' '}
                    (doanh thu hơn 50 tỷ)… đều thắng lớn doanh thu mùa Tết dù chất lượng chưa hẳn là
                    tốt so với các đối thủ cạnh tranh.
                  </p>
                  <p className="detail-news__text">
                    <b>Thái Hòa</b>
                  </p>
                  ...
                  <p className="detail-news__text">
                    ...
                    <i>Saigon Bodyguards</i> đã được Hollyood mua bản quyền chuyển thể cho Ngô Kinh
                    và Chris Pratt đóng chính).
                  </p>
                  <p className="detail-news__text">
                    <i>Chàng Vợ Của Em</i> và <i>Hồn Papa, Da Con Gái</i> giúp Thái Hòa khẳng định
                    diễn xuất nhưng doanh thu chưa thật xuất sắc. Chỉ đến khi <i>Tiệc Trăng Máu</i>{' '}
                    bùng nổ vào tháng 10, Thái Hòa mới thật sự trở lại ngôi vương.
                  </p>
                  <p className="detail-news__text">
                  ...
                  <p className="detail-news__text">
                    Trường Giang nổi lên từ phần 1 franchise <i>Lật Mặt</i> . Tác phẩm thu về 72 tỷ
                    giúp anh tìm được chỗ đứng trên thị trường phim chiếu rạp. Tên tuổi Trường Giang
                    dần khẳng định nhờ doanh thu <i>49 Ngày</i> (67 tỷ đồng), <i>Taxi, Em Tên Gì</i>{' '}
                    (47 tỷ đồng). Tuy kịch bản đều có những điểm yếu nhất định nhưng nhờ Trường
                    Giang vẫn đại thắng.
                  </p>
                  <p className="detail-news__text">
                    ...
                    thiếu chất lượng, kéo luôn Trường Giang tuột dốc. Phim đứng đầu doanh thu mùng 1
                    nhưng đã đuối sức ở giai đoạn sau, để lọt ngôi vương mùa Tết vào tay{' '}
                  ...
                  <p className="detail-news__text">
                    Tết 2019 là cuộc đấu giữa Trấn Thành và Trấn Thành. Anh tham gia cả hai bộ phim
                    cạnh tranh gay gắt nhất phòng vé lúc đó. Trấn Thành đóng chính{' '}
                  ...
                  <p className="detail-news__text">
                    ...
                    sự góp mặt của “MC quốc dân”, Bố Già đang là ứng cử viên nặng kí cho ngôi vương
                    phòng vé năm nay. Cuộc cạnh tranh giữa các tác phẩm khiến khán giả yên tâm về
                    mặt chất lượng như <i>Trạng Tí</i>, <i>Lật Mặt 48H</i>,{' '}
                  ...
                  <p className="detail-news__text">
                    Sự xuất hiện của “bóng hồng” Thu Trang giữa các “đấng mày râu” không hề bất ngờ.
                    Với những ai theo dõi “hoa hậu hài” nhiều năm qua, thành công của cô là xứng
                    đáng!
                  </p>
                  <p className="detail-news__block-image">
