                ...
                <div className="detail-news__content">
                  ...
                  <div className="detail-news__main">
                    ...
                    <p className="detail-news__text">
                      ...
                      nhạc kịch chứ không phải nói về tình bạn, họ không thích từ “đồ chơi” trong
                      tiêu đề, họ ghét việc cắt giảm sớm và tạm dừng sản xuất trong thời gian ngắn.
                      Tựu chung lại, Toy Story dường như đã bị “ghẻ lạnh” ngay từ khi mới bắt đầu.
                    </p>
                    <p className="detail-news__text">
                      Có thể ví mối quan hệ ban đầu của Pixar và Disney như David và Goliath – một
                      mối quan hệ không mấy tốt đẹp giữa người nghệ sĩ nhỏ bé, kém may mắn và một
                      “kẻ khổng lồ”. Thế nhưng trên thực tế, họ cần nhau để thành công.
                    </p>
                    ...
                    <p className="detail-news__text">
                      ...
                      này trở thành người sáng lập DreamWorks cùng Teven Spielberg và David Geffen)
                      đã có nhiều bất đồng với Jobs cũng như nhóm nhân viên của Pixar. Tuy nhiên,
                      cũng chính ông là người đã thúc đẩy ý tưởng xây dựng Toy Story thành một câu
                      chuyện về tình bạn thân đồng thời đem đến cho nó nhiều giá trị, góc nhìn hơn
                      so với các phim hoạt hình cổ điển.
                    </p>
                    <p className="detail-news__text">
                    ...
                    <p className="detail-news__text">
                      ...
                      – tất cả chỉ để giúp cho bộ phim trở nên thành công” - Ông chủ của Disney,
                      Michael Eisner nhận xét trong cuốn sách Disney War của James B Stewart.
                    </p>
                    <p className="detail-news__text">
                      Thành công của <b>Toy Story</b> đã cho phép Pixar có quyền xây dựng một thương
                      hiệu bình đẳng với Disney trong tất cả các dự án sau này, bao gồm việc quảng
                      bá và bán các sản phẩm ăn theo. Điều này đồng nghĩa với việc Pixar được công
                      nhận là một hãng phim lớn theo đúng nghĩa đen chứ không chỉ là một bộ phận
                      trực thuộc hay nhà cung cấp cho Disney.
                    </p>
                    <p className="detail-news__text">
                      Sau một thập kỷ, khi Disney mua lại Pixar với giá 7.4 tỷ đô la vào năm 2006,
                      lúc bấy giờ, Lasseter và các cộng tác viên chủ chốt của ông đã có thể giữ
                      quyền tự chủ sáng tạo của chính họ.
                    </p>
                    <p className="detail-news__text">
                      Trên tờ New York, nhà phê bình Anthony Lane đã khẳng định: Không có ai đi xem
                      một bộ phim vì nó được làm bởi Universal hay 20th Century Fox. Đấng mày râu
                      khi rời khỏi rạp chiếu phim đều không bận tâm công ty nào sản xuất bộ phim mà
                      họ vừa xem bằng việc ai đã chế tạo ra cái máy sấy tay trong nhà vệ sinh nam.
                    ...
                    <p className="detail-news__text">
                      ...
                      chỉ đầu tư vào quá trình làm phim mà còn rất coi trọng khâu xây dựng thương
                    ...
                    <p className="detail-news__text">
                      ...
                      <b>Inside Out</b> , hay cái chết trong <b>Coco</b> một cách rất cuốn hút và
                      tươi mới. Pixar cũng đã chứng minh được một điều rằng phim hoạt hình được làm
                      bằng máy tính vẫn giàu cảm xúc nhiệm màu như các tác phẩm được vẽ bằng tay
                      đáng yêu nhất mà Disney đã tạo ra được trong thời kỳ hoàng kim.
                    </p>
                    <p className="detail-news__block-image">
                    ...
                    <p className="detail-news__text">
                      ...
                      “chỉ là câu lạc bộ dành cho cánh đàn ông”. Từ vị trí đạo diễn, nhân vật chính
                      là người, một chú cá hay đồ chơi – tất cả đều có giới tính nam.
                    </p>
                    <p className="detail-news__text">
                      Năm 2012, giới điện ảnh được một dịp xôn xao khi Brenda Chapman trả lời trên
                      The New York Times rằng việc bị loại khỏi ekip làm phim <b>Brave</b> đã khiến
                      bà cảm thấy thật kinh khủng. Tuy nhiên sau đó, bà cho biết vì “tầm nhìn của
                      tôi vẫn ảnh hưởng xuyên suốt bộ phim và vì tôi đã dám lên tiếng cho chính bản
                      thân mình” nên “tôi vẫn rất tự hào về nó”.
                    </p>
                    <p className="detail-news__text">
                      ...
                      nên “một nền văn hóa không có sự bình đẳng cho phụ nữ và người da màu”. Điều
                      này khiến một hãng phim được yêu thích hàng đầu bỗng dưng trở thành “kẻ tội
                      đồ”. Mọi chuyện trở nên tồi tệ hơn khi phong trào #MeToo nổ ra và kế tiếp,
                      John Lasseter phải ra đi sau khi có nhiều đồng nghiệp nữ lên tiếng về việc ông
                      thường xuyên có những hành động quá trớn với họ.
                    </p>
                    <p className="detail-news__text">
                      Tuy nhiên như đã nói từ đầu, những bê bối này không ảnh hưởng đến chất lượng
                      làm phim của Pixar. <b>Toy Story 4</b> hay <b>Onward</b> vẫn hay và hấp dẫn,
                      vẫn nhận được nhiều đánh giá cao từ giới chuyên môn và sự thích thú lớn của
                      khán giả.
                    </p>
                    <p className="detail-news__text">
                      Kết thúc năm 2020, Pixar cho ra mắt dự án mới mang tên <b>Soul</b> – một bộ
                      phim mà hầu hết các nhà phê bình đều nhận định rằng “nó sẽ khiến trẻ em vỗ tay
                      vì thích thú và người lớn phải rớm lệ vì cảm động”. Giữa một năm mà cả thế
                      giới lao đao vì dịch bệnh, sự thành công của Pixar một lần nữa khẳng định vị
                      thế của họ: Ngoại lệ duy nhất có 1-0-2 của Hollywood!
                    </p>
                  </div>
                </div>
