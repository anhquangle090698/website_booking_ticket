        ...
        <div className="col-12 col-lg-8">
          ...
          <div className="detail-news__content">
            ...
            <div className="detail-news__main">
              ...
              <p className="detail-news__text">
                Mới đây, The Hollywood Reporter đã tiết lộ Marvel Studios đang lên kế hoạch sản xuất
                Black Panther 2 vào tháng 7.2021.
              </p>
              <p className="detail-news__block-image">
                <img src={blg3} alt={blg3} width="600px" height="350px"></img>
              </p>
              <p className="detail-news__text">
                Trang tin này cũng cho biết thêm ngôi sao người Mexico - Tenoch Huerta sẽ đảm nhiệm
                vai phản diện chính trong phần phim mới này. Tenoch Huerta từng để lại dấu ấn trong
                một số dự án phim ảnh như Here on Earth, Son of Monarchs và đặc biệt là Narcos:
                Mexico.
              </p>

              <p className="detail-news__text">
                Trong khi đó, nhân vật Shuri – em gái của T’Challa do nữ diễn viên Letitia Wright
                thể hiện được dự báo là sẽ có vai trò nổi bật, quan trọng hơn. Tuy nhiên điều này
                cũng chưa hoàn toàn đồng nghĩa với việc Marvel sẽ đưa Shuri sẽ trở thành Black
                Panther tiếp theo sau sự ra đi của Chadwick Boseman.
              </p>
              <p className="detail-news__text">
                Qua một bài phỏng vấn gần đây, Phó Giám đốc điều hành của Marvel - Victoria Alonso –
                đã thẳng thắn nói “KHÔNG” khi được hỏi về tin đồn rằng họ sẽ sử dụng CGI để thay thế
                cho Chadwick Boseman trong Black Panther 2. Như vậy rõ ràng Disney và Marvel đang
                lên một một kế hoạch để làm thế nào tiếp tục phát triển thương hiệu phim mà vẫn thể
                hiện được sự tôn trọng, tri ân với Chadwick Boseman.
              </p>
              <p className="detail-news__text">
              ...
              <p className="detail-news__text">
                ...
                trong tám năm liên tiếp và họ đã giành được chiến thắng vào năm 2017. Sự xuất hiện
                của Wendy Molyneux và Lizzie Molyneux (biên kịch của Bob's Burgers – một bộ phim
                hoạt hình sitcom của Mỹ) được cho là sẽ góp phần tăng thêm tính hài hước của bộ
                phim.
              </p>
              <p className="detail-news__text">
                Tất nhiên, vai chính của phim vẫn do ngôi sao Ryan Reynolds tiếp tục đảm nhiệm.
                Không chỉ vậy, trang tin Deaddetail-news còn cho biết ở phần 3 này, Ryan Renolds sẽ
                tham gia nhiều và sâu hơn vào quá trình sản xuất của dự án. Về vị trí đạo diễn, vì
                lịch trình của David Leich (đạo diễn Deadpool 2) đã kín cho đến năm 2021 nên Marvel
                buộc phải tìm kiếm một cái tên khác để gửi gắm niềm tin.
              </p>
              <p className="detail-news__text">
                Về nội dung, hẳn các khán giả vẫn còn nhớ ở đoạn kết của phần phim trước, với sự
                giúp đỡ của máy du hành, Deadpool đã có thể nhảy vào bất kỳ dòng thời gian nào mà
                anh ấy muốn. Có lẽ đây sẽ chính là cầu nối để MCU đưa anh chàng “bất trị” này gia
                nhập đội ngũ của các Avengers. Sẽ ra sao nếu vào một ngày đẹp trời, Deadpool và
                Doctor Strange vô tình gặp nhau khi đang chu du khắp các thực tại nhỉ?
              </p>
              <p className="detail-news__text">
                Dù thế nào đi nữa, việc Deadpool được sản xuất bởi đội ngũ sáng tạo của Marvel
                Studios chắc chắn sẽ tạo nên những chuyến phiêu lưu mới không kém phần thú vị và hấp
                dẫn.
              </p>
              <p className="detail-news__block-image">
              ...
              <p className="detail-news__text">
                Một tin tức khác liên quan đến phim mới Thor: Love And Thunder. Theo The Hollywood
                Reporter đưa tin, Thor 4 sẽ có dàn diễn viên đông đảo, đa dạng, phong phú đến mức có
                thể ví phần phim này như Avengers 5.
              </p>

              <p className="detail-news__text">
                Trước đó, nhân vật Star-Lord do Chris Pratt thể hiện đã được xác nhận là sẽ góp mặt
                trong Thor: Love And Thunder. Trong khi đấy, vai diễn của ngôi sao Chris Blae vẫn
                hoàn toàn được giấu kín.
              </p>
              <p className="detail-news__text">
                Thor: Love And Thunder dự kiến ​​khởi quay vào tháng 1.2021 và dự kiến ​​phát hành
                vào ngày 11.2.2022.
              </p>
              <p className="detail-news__block-image">
              ...
              <p className="detail-news__text">
                Cuối cùng, The Hollywood Reporter cho biết Guardians of the Galaxy Vol. 3 sẽ bắt đầu
                sản xuất vào cuối năm 2021 dưới sự chỉ đạo của đạo diễn James Gunn.
              </p>
              <p className="detail-news__text">
                Ban đầu, dự án này được dự định sẽ phát hành tại rạp chiếu phim vào năm 2020. Tuy
                nhiên, những rắc rối trong quá khứ đã khiến James Gunn bị sa thải dù cho kịch bản
                của Guardians of the Galaxy Vol. 3 đã hoàn tất. Sau đấy, chính Disney lại mời vị đạo
                diễn này quay trở lại và tiếp tục cầm trịch dự án. Thế nhưng lúc bấy giờ, James Gunn
                đang tham gia vào tác phẩm The Suicide Squad của DC nên chỉ sau khi hoàn tất hợp
                đồng với Warner Bros., anh mới có thể quay trở lại tiếp tục thực hiện Vệ Binh Dải
                Ngân Hà 3.
              </p>
              <p className="detail-news__text">
