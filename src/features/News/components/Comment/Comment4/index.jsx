            ...
            <div className="col-12 col-lg-8">
              ...
              <div className="detail-news__content">
                ...
                <div className="detail-news__main">
                  ...
                  <p className="detail-news__text">
                    Xuyên suốt phim là hành trình trốn chạy khỏi sự truy nã của cảnh sát, đồng thời
                    Lâm và Khánh cũng kiên trì điều tra xem liệu hung thủ thật sự là người nào. Bối
                    cảnh Sài Gòn hiện lên thông qua khu các hẻm chợ, dãy nhà bình dân, các khu căn
                    hộ cao cấp và những vùng ngoại ô vắng vẻ. Địa điểm xảy ra án mạng chính là tòa
                    chung cư cũ đã xuống cấp, cũng là nơi được miêu tả kỹ nhất. Gần như rất dễ để
                    cảm nhận nét bí ẩn, sự đáng sợ bao trùm lên cả nơi đây, đấy là chỗ hiện diện của
                    “ác quỷ”.
                  </p>
                  <p className="detail-news__text">
                    Điểm sáng tiếp theo của tác phẩm chính là ở cách triển khai tâm lý nhân vật. Tâm
                    lý tội phạm trong phim không hề được nhắc đến chỉ bằng vài câu thoại vô thưởng
                    vô phạt, sự tổn thương trong quá khứ chính là nguyên nhân dẫn dắt đến hành động
                    “máu lạnh” của kẻ giết người. Căn bệnh tâm lý đặc biệt cũng là nguồn cơn khởi
                    đầu cho sự tang thương trải dài cả một cuộc đời của hung thủ.
                  </p>
                  <p className="detail-news__text">
                    ...
                    thân, thương yêu con của mình hết mực, luôn vững vàng trước mọi thử thách và khó
                    khăn của cuộc đời, chỉ dừng ở mức tròn vai. Vẫn còn những hạn chế ở đài từ và
                    biểu cảm chưa bộc lộ trọn vẹn.
                  </p>
                  <p className="detail-news__text">
                  ...
                  <p className="detail-news__text">
                    ...
                    nhìn cứ ngỡ đâu đây chỉ là một nhân vật phụ nhạt nhòa, thế nhưng mỗi hành vi của
                    Dustin đều có chủ đích. Đây cũng là nhân tố quan trọng góp phần đẩy mạch phim
                    lên cao trào.
                  </p>
                  <p className="detail-news__block-image">
                  ...
                  <p className="detail-news__text">
                    ...
                    luôn ở bên cạnh và tin tưởng cô chính là Lâm. B Trần với gương mặt điển trai sẵn
                    có là lựa chọn đúng đắn nhất cho nhân vật Lâm “si tình”. Lâm thương thầm Khánh
                    từ rất lâu, ngay khi xảy ra chuyện anh đã không suy nghĩ nhiều, lập tức dắt hai
                    mẹ con cô bỏ trốn. Do đất diễn chiếm phần lớn thời lượng phim, thế nên diễn biến
                    tâm lý của Lâm cũng đem đến sự đồng cảm nhiều hơn, B Trần cùng Hoàng Thùy Linh
                    ghi điểm khi có màn hợp tác khá ăn ý.
                  </p>
                  <p className="detail-news__text">
                    Tuy nhiên yếu tố trinh thám trong phim vẫn còn tồn tại sự bất hợp lý. Hành trình
                    điều tra phá án của Lâm và Khánh vẫn còn quá đơn giản, mọi thứ còn mang tính sắp
                    đặt của đạo diễn, dẫn đến mục đích của các nhân vật đều đạt được dễ dàng. Điều
                    này khiến cho nhiều phân đoạn trong phim nghiêng về hướng tình cảm, trở thành
                    câu chuyện tình yêu khiên cưỡng, còn vụ án mạng lại biến thành câu chuyện phụ,
                    làm nền một cách mờ nhạt. Có thể đối với những ai khó tính, việc các tình huống
                    hài hước không đúng chỗ hoặc sướt mướt chưa đúng lúc sẽ khiến cho mạch cảm xúc
                    khi thưởng thức phim bị đứt đoạn.
                  </p>
                  <p className="detail-news__text">
                    Bên cạnh đó, tông màu của phim cũng gây khó hiểu khi liên tục thay đổi, lúc mang
                    sắc xám nhạt, sau đấy lại chuyển sang nhuộm ánh vàng một cách cường điệu.
                  </p>
                  <p className="detail-news__text">
                    Có thể thấy rằng, dù tồn tại nhiều điểm bất cập trong khâu triển khai kịch bản,
                    nhưng không thể phủ nhận rằng đây sẽ là thể loại tiềm năng sắp tới đối với các
                    nhà làm phim. Một tín hiệu vui đối với điện ảnh nước nhà,{' '}
