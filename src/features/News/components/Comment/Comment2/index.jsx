                ...
                <div className="detail-news__content">
                  ...
                  <div className="detail-news__main">
                    <p className="detail-news__text">
                      ...
                      <b>Gia Đình Croods: Kỷ Nguyên Mới</b> có thể tóm tắt bằng những yếu tố vừa
                      được liệt kê.
                    </p>
                    <p className="detail-news__text">
                      Đã bảy năm kể từ sau thành công rực rỡ của <i>The Croods</i> (2013), lần này
                      nhà Croods quay trở lại với chuyến phiêu lưu mới đầy hấp dẫn và không kém phần
                      “lầy lội”.
                    </p>
                    <p className="detail-news__text">
                      Những gì vốn từng ghi điểm với khán giả ở phần một đã tiếp tục phát huy tối đa
                      trong lần trở lại này. Vẫn là thế giới tiền sử đầy hoang sơ, nguy hiểm từ
                      những loài sinh vật lạ rình rập khắp nơi, thế nhưng toàn bộ thời lượng phim
                      lại đem đến các gam màu tươi sáng, rực rỡ.
                    </p>
                    <p className="detail-news__text">
                    ...
                    <p className="detail-news__text">
                      Trong khi nhà Croods đại diện cho những điều thuần khiết và hoang dại nhất,
                      thì phía hộ Betterman lại là những cá thể có phần “thượng đẳng” hơn. Họ tiến
                      bộ không chỉ ở lối tư duy, cốt cách con người, mà ngay cả căn nhà cũng được
                      Phil thiết kế như một khu nghỉ dưỡng 5 sao sang trọng. Đầy đủ tiện nghi, thân
                      thiện với môi trường, hiện đại bậc nhất thời kỳ đồ đá.
                    </p>
                    <p className="detail-news__text">
                      Hiển nhiên nghe qua cũng dễ dàng nhận ra được sự khác biệt giữa hai bên gia
                      đình, điều này dẫn đến mâu thuẫn để rồi từ đấy đặt ra hàng loạt thử thách để
                      các nhân vật chỉ còn cách đoàn kết với nhau giải quyết tất cả.
                    </p>
                    ...
                    <p className="detail-news__text">
                      Câu chuyện của <i>The Croods 2</i> mang hơi thở thời đại, lồng ghép nhiều ẩn
                      dụ nhằm phê phán chính những con người trong xã hội ngày nay. Cậu con trai
                      Thunk của nhà Croods lúc thì trở nên thụ động, chỉ biết đắm chìm vào cảnh
                      quang thiên nhiên thông qua ô cửa sổ lớn mà không chịu bước ra ngoài khám phá
                      để có những trải nghiệm tuyệt hơn. Khi thì cầm trên tay khung gỗ nhỏ, nhìn qua
                      đấy và tự tưởng tượng đấy như ô cửa sổ di động để cậu tiếp tục quan sát mọi
                      thứ.
                    </p>

                    <p className="detail-news__text">
                      Cửa sổ rộng lớn hay khung gỗ nhỏ mang dáng dấp của chiếc TV và những chiếc
                      điện thoại thông minh, Ipad…. Trẻ nhỏ thời hiện đại dường như cũng đang quá lệ
                      thuộc vào các thiết bị điện tử, dần dần quên đi mất thế giới rộng lớn bên
                      ngoài vẫn còn nhiều điều đáng để học tập.
                    </p>
                    <p className="detail-news__text">
                      Đã là bố mẹ, ai cũng dành tình yêu thương vô bờ bến dành cho con mình. Thế
                      nhưng đôi khi chính sự bảo bọc quá mức ấy cũng chưa hẳn là tốt cho đứa trẻ.
                      Tưởng như cô bé Dawn sống trong một mái ấm hoàn hảo mà ông bố Phil Betterman
                      của mình tạo ra sẽ thật vui vẻ. Nhưng không, khu nhà rộng lớn ấy thực chất
                      chẳng khác gì một cái hang của người tiền sử, một vùng an toàn mà Dawn đã quá
                      chán ngấy. Thậm chí cô bé sẵn sàng mong muốn có được những “vết sẹo”, như để
                      thể hiện một niềm tự hào khi đã được tận hưởng những điều thú vị bên ngoài bức
                      tường của ngôi nhà.
                    </p>
                    <p className="detail-news__text">
                      ...
                      của bậc phụ huynh, dù là ở bất cứ thời đại nào thì cha mẹ chỉ muốn đem đến
                      những thứ tốt đẹp nhất cho con của họ.
                    </p>
                    <p className="detail-news__text">
                      Nơi nào có ánh sáng thì chỗ đấy sẽ là đường dẫn đến ngày mai tươi đẹp hơn. Thế
                      nhưng đôi lúc những điều tốt đẹp mà con người luôn ra sức tìm kiếm, vốn đã
                      hiện hữu ở cạnh họ ngay trong thời khắc hiện tại. Đây cũng chính là thứ giá
                      trị mà Guy đã nhận ra, khi trải qua nhiều biến cố cuộc đời. Đã có tình thân
                      gia đình thì ắt hẳn cần nhắc đến tình cảm đôi lứa. Chàng trai Guy và cô nàng
                      Eep cũng để lại ấn tượng bằng bữa đại tiệc tình yêu tuổi mới lớn “sến tới
                    ...
                    <p className="detail-news__text">
                      ...
                      nói tưởng chừng sáo rỗng của Guy lẫn Eep đủ khiến chúng ta phải suy ngẫm về
                      cách nhìn nhận yêu thương đúng nghĩa.
                    </p>
                    <p className="detail-news__block-image">
                      <img src={cmt21} alt={cmt21} width="600px" height="350px"></img>
                    </p>
                    <p className="detail-news__text">
                      Đặc biệt nhất chính là yếu tố nữ quyền, đây có lẽ là phần chiếm trọn
                      “spotlight” ở trường đoạn cuối phim. Điều đáng khen ở đây chính là biên kịch
                      đã vô cùng khéo léo khi cài cắm chi tiết mang tính thời đại vào, không hề gây
                      cảm giác gượng ép khiên cưỡng. Thay vì bố trí theo tính chất sắp đặt, “nữ
                      quyền” xuất hiện theo cách bất ngờ nhất, đem lại cảm giác phấn khích và khi
                      kết thúc cũng làm tất cả phải trầm trồ thán phục.
                    </p>
                    <p className="detail-news__text">
                    ...
                    <p className="detail-news__text">
                      Năm 2013, <i>The Croods</i> quy tụ dàn lồng tiếng gồm những ngôi sao hạng A
                      của Hollywood như Nicolas Cage, Emma Stone, Ryan Reynolds, Catherine Keener,
                      tác phẩm đã nhận đề cử Oscar ở hạng mục Phim Hoạt Hình Xuất Sắc. Ở lần hội ngộ
                      này, ngoài sự quay trở lại của các gương mặt cũ thì còn có sự góp giọng của
                      Leslie Man, Peter Dinklage và nữ diễn viên gốc Việt Kelly Marie Trần.
                    </p>
                    <p className="detail-news__text">
