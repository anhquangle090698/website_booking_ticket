              ...
              <div className="col-12 col-lg-8">
                ...
                <div className="detail-news__content">
                  <h2 className="detail-news__title">
                    {' '}
                    [Preview] Demon Slayer: "Diệt Gọn" Khương Tử Nha Trên Bảng Doanh Thu Phòng Vé
                    Toàn Cầu
                  </h2>
                  <div className="detail-news__main">
                    <p className="detail-news__text">
                      Trong năm 2020, khi phòng vé vô cùng ảm đạm vì đại dịch Covid-19, phim điện
                      ảnh Demon Slayer: Kimetsu No Yaiba the Movie: Mugen Train thắng lớn ở Nhật Bản
                      với hơn 20 triệu lượt người xem, thu về xấp xỉ 265 triệu $.
                    </p>
                    <p className="detail-news__text">
                      Trong năm 2020, <em>Kimetsu No Yaiba</em> hiện diện khắp nơi, với hàng loạt
                      vật phẩm ăn theo, gây sốt khắp thế giới.
                    </p>
                    <p className="detail-news__text">
                      ...
                      lục tồn tại suốt vài chục năm của siêu phẩm và chỉ chịu thua hoạt hình kinh
                      điển Spirited Away.
                    </p>
                    <p className="detail-news__text">
                      Tại Việt Nam, nơi chú mèo máy Doraemon luôn vững vàng ngồi top 1 doanh thu
                      phòng vé, cuộc “so găng” tháng 12 – Kimetsu No Yaiba và Doraemon: Nobita's New
                    ...
                    <p className="detail-news__text">
                      ...
                      dài đầu tay của tác giả Gotouge Koyoharu – biệt danh Cá Sấu-sensei. So với
                      những tuyệt phẩm lừng lẫy giới manga như <i>One Piece</i>{' '}
                      <b>Kimetsu No Yaiba</b> kết thúc khá nhanh. Tuy vậy, điều này không hề ảnh
                      hưởng tới sự nổi tiếng nó tạo ra. Mới vài năm ngắn ngủi, <b>Demon Slayer</b>{' '}
                      đã trở thành “thế lực” lớn. Cá Sấu-sensei nay có thể học theo hai bậc tiền bối
                      Takeuchi Naoko (tác giả Sailormoon / Thủy Thủ Mặt Trăng) và Takahashi Kazuki
                      (tác giả Yu-Gi-Oh! / Vua Trò Chơi) chỉ cần một tác phẩm là đủ ăn cả đời.
                    </p>
                    <p className="detail-news__text">
                      Lấy bối cảnh thời cận đại, <i>Kimetsu No Yaiba</i> kể về Kamado Tanjiro 13
                      tuổi – một cậu bé hết sức bình thường. Cha mất sớm, Tanjiro nhận trách nhiệm
                      chăm lo cho mẹ và 5 đứa em. Ngày nọ, lỡ đem than xuống núi bán rồi về trễ,
                      Tanjiro bàng hoàng phát hiện cả nhà đều bị sát hại dã man. Cõng trên lưng cô
                      em gái Nezuko vẫn còn hơi ấm, cậu chạy thục mạng giữa trời tuyết để tìm thầy
                      thuốc. Trong khi đó, Nezuko từ từ biến đổi. Truyền thuyết quỷ dữ mà Tanjirou
                      tưởng chỉ có nơi truyền thuyết bỗng hóa thành hiện thực bi thương.
                    </p>
                    <p className="detail-news__text">
                      Lúc Tanjiro đang bị Nezuko tấn công, một người lạ mặt xuất hiện. Anh ta giải
                      cứu cậu và đòi chặt đầu Nezuko. Đó là Tomioka Giyuu – thành viên Đội Diệt quỷ.
                      Tuy vậy, cảm động trước tình cảm Tanjiro dành cho em, cũng như chứng kiến
                      Nezuko bảo vệ anh mình, Tomioka giới thiệu họ đến gặp ông lão Urokodaki
                      Sankoji để học tập trở thành kiếm sĩ diệt quỷ. Tanjiro – với quyết tâm tìm ra
                      kẻ sát hại gia đình và giúp em gái Nezuko trở lại thành người, dấn thân vào
                    ...
                    <p className="detail-news__text">
                      ...
                      <i>Kimetsu No Yaiba</i> phim hay <b>Mugen Train</b> còn hấp dẫn bội phần khi
                      Trụ Cột vốn đông người hâm mộ - Viêm trụ giữ vai trò chính. Ở cuộc khảo sát
                      bên lề, đến hơn 70% khán giả chọn Rengoku làm lý do họ ra rạp.
                    </p>
                    <p className="detail-news__text">
                      Qua trailer, đồ họa và màu sắc vốn là điểm mạnh, hút fan của phiên bản anime
                      vẫn hoàn hảo như thế trên bản điện ảnh. Âm nhạc khơi gợi cảm xúc cũng thành
                      điểm cộng hoàn hảo.{' '}
                    </p>
                    <p className="detail-news__text">
                    ...
                    <p className="detail-news__text">
                      Tại Việt Nam, nếu đặt suất chiếu sớm, các fan còn nhận thêm bộ quà khủng gồm
                      05 huy hiệu đầy đủ các nhân vật, 03 poster A2, 01 áo thun và 01 bìa hồ sơ.
                    </p>
                  </div>
                </div>
